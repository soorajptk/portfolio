  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row px-4 md:px-0 gap-[1.5rem] items-center justify-between pt-2 pb-[1.2rem]">
        <img
          className="md:w-[12.125rem] md:h-[12.125rem] object-fill"
          src={dpImg}
          alt="designer profile"
        />
        <div className=" flex-1 rounded-xl backdrop-blur-md bg-white/15 p-[1.25rem] px-[1.188rem] md:px-[2.25rem]">
          <h2 className="text-light-gray text-justify text-[0.75rem] leading-[1.313rem] sm:text-[1rem] font-medium  md:leading-[1.938rem]">
